...
class MAVEN:
    def __init__(self, args):
        ...
        if self.args.load_model:
            ...
            if os.path.exists(self.model_dir + num + '/rnn_net_params.pt'):
                path_z_policy = self.model_dir + num + '/z_policy_params.pt'
                path_rnn = self.model_dir + num + '/rnn_net_params.pt'
                path_qmix = self.model_dir + num + '/qmix_net_params.pt'
                path_mi = self.model_dir + num + '/mi_net_params.pt'
    ...
    def save_model(self, train_step):
        ...
        torch.save(self.eval_qmix_net.state_dict(),
                   self.model_dir + '/' + num + '_qmix_net_params.pt')
