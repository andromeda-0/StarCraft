...
tmux send-keys -t PORightFixed_Heterogeneous_reinforce_g2anet "cd ..; conda activate gym_graph; python main.py --alg=reinforce+g2anet --device 5 --map saturn.PORightFixed_Heterogeneous --run_id 5.21 --n_steps 20000000" Enter
tmux new -d -s PORightFixed_Heterogeneous_qmix
tmux send-keys -t PORightFixed_Heterogeneous_qmix "cd ..; conda activate gym_graph; python main.py --alg=qmix --device 5 --map saturn.PORightFixed_Heterogeneous --run_id 5.21 --n_steps 20000000" Enter
tmux new -d -s PORightFixed_Heterogeneous_maven
tmux send-keys -t PORightFixed_Heterogeneous_maven "cd ..; conda activate gym_graph; python main.py --alg=maven --device 5 --map saturn.PORightFixed_Heterogeneous --run_id 5.21 --n_steps 20000000" Enter
